...
const Sidebar = () => {
	...
	return (
		<div className="z-10 fixed left-0 top-0 md:w-[230px] w-[60px] overflow-hidden h-full flex flex-col">
			<div className={`w-full flex items-center md:justify-start justify-center md:pl-5 h-[70px] ${isDarkMode? "bg-black":"bg-white"} `}>
			...
			<div className={`w-full h-[calc(100vh-70px)] border-r flex flex-col md:items-start items-center gap-2 ${isDarkMode? "bg-black text-white":"bg-white border-slate-300"} py-5 md:px-3 px-3 relative`}>
				{navLinks.map((link) => {
					return (
						<div
							key={link.title}
				...
				<div onClick={toggleMode} className="flex absolute bottom-4 items-center md:justify-start justify-center gap-2 md:w-[90%] w-[70%] rounded-lg hover:bg-orange-300 px-2 py-3 cursor-pointer bg-gray-200">
					<LogOutOutline />
