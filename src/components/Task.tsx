...
const Task = ({ task, provided }: TaskProps) => {
	const { title, description, priority, deadline, image, alt, tags, status } = task;
	...
	return (
		...
		>
			<div className="w-full flex items-start flex-col gap-0">
				<span className="text-[15.5px] font-extrabold font-sans text-black">MT-10035 {status}</span>
			</div>
